...
import com.redmath.studentapp.core.Student;
...
public class StudentControllerTest {
    ...
    public void testStudentGet() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/student/studentsByName")
                        .param("name","ali a"))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().is2xxSuccessful());

        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/student/studentsByNameLike")
                        .param("name","a"))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().is2xxSuccessful());
    }
    ...
    private RequestPostProcessor testUser(String uname, String authoriy) {
        return SecurityMockMvcRequestPostProcessors.user(uname).authorities(new SimpleGrantedAuthority(authoriy));
    }
}
